...
class Graph(object):
    ...
    def dfs_helper(self, start_node):
        ...
        #print 'start_node.value =', start_node.value
        #for e in start_node.edges:
            #print 'start_node.edges.node_from, node_to =({},{})'.format(e.node_from.value,
            #                                                            e.node_to.value)
        for e in start_node.edges:
            #print 'e.node_to.value = ', e.node_to.value
    ...
    def dfs_helper_instruction_answer(self, start_node):
        ...
        while len(q) > 0:
            ...
            for e in n.edges:
                if not e.node_to.visited:
                    ...
                    ret_list.append(e.node_to.value)
                    q.append(e.node_to)
                    #print ret_list, e.node_to.visited
        return ret_list
    
    def bfs_instruction_answer(self, start_node_num):
